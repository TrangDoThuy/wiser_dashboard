...
const tour = {
    ...
    steps: [
      {
        ...
        content: () => (
          <div>
            ...
            <br />
            <h4>
              Welcome to the official demo <strong>Hualiang - Finmonster Dashboard!</strong>
            </h4>
            <br />
  ...
  'content-type-builder': {
    steps: [
      ...
      {
        selector:
          'a[href="/admin/plugins/content-type-builder/content-types/application::project.project"]',
        content: () => (
          <div>
            <h1>Project Collection Type</h1>
            <br />
            <ul>
              <li>
...

      {
        ...
        content: () => (
          <div>
            <h1>Single type</h1>
            <br />
            It may seem complicated but this single type is composed of a <strong>
              Columns
            </strong>{' '}
            component which itself contains a <strong>Link</strong> component.
            <br />
          </div>
        ),
      },
      ...
      {
        selector:
          'a[href="/admin/plugins/content-manager/collectionType/application::project.project?page=1&pageSize=10&_sort=name:ASC&plugins[i18n][locale]=en"]',
        content: () => (
          <div>
            <h1>Content Manager</h1>
            <br />
            Let's browse our projects!
            <br />
            <br />
            <ul>
              <li>
                <strong>Click</strong> on the Project collection type.
              </li>
            </ul>
          </div>
        ),
      ...
      },
      {
        ...
        content: () => (
          <div>
            ...
            <br />
            <strong>Right:</strong> Configure what fields and relations you want to see in this
            view.
          </div>
        ),
      },
      ...
      },
      {
        ...
        content: () => (
          <div>
            ...
            (Content-Types Builder - Edit Project - Advanced settings), which allows you to create
            the same entry but for a different locale.
            <br />
        ...
        content: () => (
          <div>
            ...
            <ul>
              ...
              <li>
                <strong>Add /projects</strong> just after the host of your demo url (ex:
                https://api-4p93j.strapidemo.com<strong>/projects</strong>) to see all your
                projects!
              </li>
            </ul>
          </div>
      ...
      },
      {
        ...
        content: () => (
          <div>
            ...
            fields: name (<strong>text</strong>), ingredients (<strong>enumeration</strong>), amount
            (<strong>number - decimal</strong>) and a relation linking to your Project collection
            type with the following expression: <strong>Project has many dishes</strong>.<br />
            <br />
            So you will be able to add dishes to your projects!
          </div>
        ),
      },
      {
